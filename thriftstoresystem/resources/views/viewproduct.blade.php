...
@section('content')
        ...
        <div class="col-span-2 border-x px-4">
            ...
            <form action="{{ route('cart.store') }}" method="POST">
                ...
                <div class="flex mt-10">
                    ...
                    <input type="text" class="w-14 text-center border-none bg-gray-100" value="1" id="qty"
                        name="qty" readonly>
                    <button class="px-4 bg-gray-200 block py-2 cursor-pointer" onclick="return inc()">+</button>
                </div>
                <p class="tetx-gray-400">In Stock:{{ $product->stock }}</p>
    ...
    <div class="mt-10 px-16">
        ...
        <p class="tetx-gray-500">{{ $product->description }}</p>
    </div>
    <div class="px-16">
